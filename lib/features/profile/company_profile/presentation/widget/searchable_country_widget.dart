...
class SearchableCountryWidget extends StatefulWidget {
  final List<Country> items; // List of dropdown options
  final Country? selectedItem; // Pre-selected item (optional)
  ...
  @override
  _SearchableCountryWidgetState createState() =>
      _SearchableCountryWidgetState();
}

class _SearchableCountryWidgetState extends State<SearchableCountryWidget> {
